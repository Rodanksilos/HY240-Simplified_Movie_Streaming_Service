...
extern movie_t category_guard;
extern int hash_a;
extern int hash_b;
extern int prime_num;
extern movie_t* tmp_array[6];
 ...
 */
 ...
 /**
  * @brief Frees all nodes in user's watch history
  * @param root root of user's watch history
  */
